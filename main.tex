...
% Redefine the chapter command to show only the number and title without "Capítulo"
...
\include{caps/linguagem}
\include{caps/principais_app}
\include{caps/versoes}
\include{caps/aplicacao}
\include{caps/conclusao}
%\include{chap3}
